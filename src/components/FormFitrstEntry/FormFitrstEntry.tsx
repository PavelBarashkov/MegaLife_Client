...
import { ACCOUNTS_ROUTE } from "../../routes/consts";
...
export const FormFitrstEntry = () => {
  ...
  const [fetchUser, isUserInfoLoading, userInfoError] = useFetching(
  ...
  return (
    <>
      {isPasswordChange ? (
        ...
        <>
          <Logo />
          <TitileForm> Создание нового пароля </TitileForm>
          <InputNewPassword />
          <InputWithBtn
          ...
          <p className="form-info">
            Нажимая кнопку, я соглашаюсь с условиями<br></br>{" "}
            <a href="!#" className="convention">
